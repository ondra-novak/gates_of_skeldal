...
//    {H_MS_LIST,"msc_list.pcx", pcx_8bit_decomp,SR_BGRAFIKA},
    ...
    {H_SND_SWHIT1,"swd_hit0.wav",soundfx_load,SR_ZVUKY},
    {H_SND_SWHIT2,"swd_hit1.wav",soundfx_load,SR_ZVUKY},
    {H_SND_SWMISS1,"swd_mis0.wav",soundfx_load,SR_ZVUKY},
    {H_SND_SWMISS2,"swd_mis1.wav",soundfx_load,SR_ZVUKY},
    {H_SND_SIP1,"sip2.wav",soundfx_load,SR_ZVUKY},
    {H_SND_SIP2,"sip1.wav",soundfx_load,SR_ZVUKY},
    {H_SND_KNIHA,"kniha.wav",soundfx_load,SR_ZVUKY},
    {H_SND_OBCHOD,"obchod.wav",soundfx_load,SR_ZVUKY},
    {H_SND_LEKTVAR,"lektvar.wav",soundfx_load,SR_ZVUKY},
    {H_SND_TELEPIN,"telepin.wav",soundfx_load,SR_ZVUKY},
    {H_SND_TELEPOUT,"telepout.wav",soundfx_load,SR_ZVUKY},
    {H_SND_HEK1M,"jauu1m.wav",soundfx_load,SR_ZVUKY},
    {H_SND_HEK2M,"jauu2m.wav",soundfx_load,SR_ZVUKY},
    {H_SND_HEK1F,"jauu1f.wav",soundfx_load,SR_ZVUKY},
    {H_SND_HEK2F,"jauu2f.wav",soundfx_load,SR_ZVUKY},
    {H_SND_EAT,"jidlo.wav",soundfx_load,SR_ZVUKY},
    {H_SND_WEAR,"obleci.wav",soundfx_load,SR_ZVUKY},
    {H_SND_PUTINV,"put_inv.wav",soundfx_load,SR_ZVUKY},
    ...
    {H_FLETNA,"fletna.wav",soundfx_load,SR_ZVUKY},
    {H_FLETNA_BAR,"stupnice.pcx",pcx_8bit_decomp,SR_BGRAFIKA},
    {H_FLETNA_MASK,"stupni_m.pcx",pcx_8bit_nopal,SR_BGRAFIKA},
    {H_SND_SEVER,"sever.wav",soundfx_load,SR_ZVUKY},
    {H_SND_VYCHOD,"vychod.wav",soundfx_load,SR_ZVUKY},
    {H_SND_JIH,"jih.wav",soundfx_load,SR_ZVUKY},
    {H_SND_ZAPAD,"zapad.wav",soundfx_load,SR_ZVUKY},
    {H_SND_RAND1,"random1.wav",soundfx_load,SR_ZVUKY},
    {H_SND_RAND2,"random2.wav",soundfx_load,SR_ZVUKY},
    {H_SND_RAND3,"random3.wav",soundfx_load,SR_ZVUKY},
    {H_SND_RAND4,"random4.wav",soundfx_load,SR_ZVUKY},
